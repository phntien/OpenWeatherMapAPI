...
public class TC_API_0001_Get_current_weather_data_with_VALID_CityName extends BaseTest {

    @Test(dataProvider = "excelData", dataProviderClass = DataProviderFactory.class)
    public void TC_API_0001_Get_current_weather_data_with_VALID_CityName(Map<String, String> data) {
