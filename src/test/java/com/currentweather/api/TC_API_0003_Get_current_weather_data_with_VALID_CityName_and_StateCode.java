...
public class TC_API_0003_Get_current_weather_data_with_VALID_CityName_and_StateCode extends BaseTest {

    @Test(dataProvider = "excelData", dataProviderClass = DataProviderFactory.class)
    public void TC_API_0003_Get_current_weather_data_with_VALID_CityName_and_StateCode(Map<String, String> data) {
