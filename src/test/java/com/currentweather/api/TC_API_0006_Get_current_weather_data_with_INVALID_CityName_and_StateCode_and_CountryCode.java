...
public class TC_API_0006_Get_current_weather_data_with_INVALID_CityName_and_StateCode_and_CountryCode extends BaseTest {

    @Test(dataProvider = "excelData", dataProviderClass = DataProviderFactory.class)
    public void TC_API_0006_Get_current_weather_data_with_INVALID_CityName_and_StateCode_and_CountryCode(Map<String, String> data) {

        String cityName = data.get("InvalidCityName");
        String sateName = data.get("InvalidStateCode");
        String countryName = data.get("InvalidCountryCode");
